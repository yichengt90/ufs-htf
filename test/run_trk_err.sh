...
ln -fs ${TEST_DIR}/archive/ATM_c96_Barry/trak.gfso.atcfunix.altg.2019071200 ./trak.gfso.atcfunix.altg.2019071200.atm
ln -fs ${TEST_DIR}/archive/S2S_c96_Barry/trak.gfso.atcfunix.altg.2019071200 ./trak.gfso.atcfunix.altg.2019071200.s2s
ln -fs ${TEST_DIR}/archive/S2SW_c96_Barry/trak.gfso.atcfunix.altg.2019071200 ./trak.gfso.atcfunix.altg.2019071200.s2sw
